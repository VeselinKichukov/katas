...
class StringCalculatorTest extends TestCase
{
    ...
    /** @test */
    function it_finnds_the_sum_of_a_single_number()
    {
        $calculator = new StringCalculator;
    ...
    /** @test */
    function it_finnds_the_sum_of_any_amount_of_numbers()
    {
        $calculator = new StringCalculator;

        $this->assertSame(25, $calculator->add('5,5,5,5,5'));
    }

    /** @test */
    function it_accepts_new_line_as_a_delimiter()
    {
        $calculator = new StringCalculator;
